...
<body>
    <main class="container d-flex justify-content-center align-items-center min-vh-100 py-5">
        <div class="login-wrapper shadow border border-primary rounded p-4 p-md-5 text-center d-flex flex-column align-items-center gap-3" style="max-width: 700px; width:100%;">
            ...
            <form action="/functions/editvehicle.php" method="post" enctype="multipart/form-data" class="formulario-login text-start w-100 mt-3" style="max-width: 560px;">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="plateNum" name="plateNum" class="form-control" placeholder="Placa" value="<?= htmlspecialchars($plateNum) ?>" required>
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="color" class="form-label fw-bold text-dark">Color</label>
                        <input type="text" id="color" name="color" class="form-control" value="<?= htmlspecialchars($color) ?>" required>
                    </div>
                </div>
                ...
                <div class="row g-3 mt-1">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="brand" name="brand" class="form-control" value="<?= htmlspecialchars($brand) ?>" required>
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="model" class="form-label fw-bold text-dark">Modelo</label>
                        <input type="text" id="model" name="model" class="form-control" value="<?= htmlspecialchars($model) ?>" required>
                    </div>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <?php if (!empty($image)): ?>
                        <div class="mb-2">
                            ...
                            <img src="<?= htmlspecialchars($image) ?>" alt="Foto vehículo actual" style="max-width: 150px; height: auto; border-radius: 4px;">
