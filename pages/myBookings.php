                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="mt-2 d-flex gap-2">
                                            ...
                                            <form method="POST" action="/functions/editBooking.php">
                                                <input type="hidden" name="id"
                                                    value="<?= htmlspecialchars($b['id'] ?? '') ?>">
                                                <input type="hidden" name="ride_id"
                                                    value="<?= htmlspecialchars($b['ride_id'] ?? '') ?>">
                                        ...
                                        <?php endif; ?>
                                        <?php if ($userType == 'user' && ( ($b['booking_state'] ?? '') == 'pendiente' || ($b['booking_state'] ?? '') == 'accepted' )): ?>
                                        <div class="mt-2 d-flex gap-2">
                                            ...
                                            <form method="POST" action="/functions/editBooking.php">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-success">Cancelar</button>
                                            </form>
