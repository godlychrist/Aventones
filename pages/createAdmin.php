...
<body>
    <main class="container d-flex justify-content-center align-items-center min-vh-100 py-5">
        <div class="login-wrapper shadow border border-primary rounded p-4 p-md-5 text-center d-flex flex-column align-items-center gap-3"
            ...
            <!-- FORMULARIO -->
            <form action="/functions/insertAdmin.php" method="post" enctype="multipart/form-data"
                ...
                <div class="row g-3 mt-1">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="cedula" name="cedula" class="form-control" placeholder="1-2345-6789"
                            required>
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <div class="row g-3 mt-1">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="email" id="correo" name="correo" class="form-control" placeholder="tu@correo.com"
                            required>
                    </div>
                    <div class="col-12 col-md-6">
